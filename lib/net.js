...
var protoVersion = protodef.VersionDummy.Version.V1_0,
...
var HANDSHAKE_SUCCESS = "SUCCESS";
var HANDSHAKE_AUTHFAIL = "ERROR: Incorrect authorization key.\n";
...
function TcpConnection(host, callback) {
  ...
  TcpConnection.super_.call(this, host, callback);
  if (this.ssl) {
...
function HttpConnection(host, callback) {
  ...
  HttpConnection.super_.call(this, host, callback);
...
util.inherits(HttpConnection, Connection);
